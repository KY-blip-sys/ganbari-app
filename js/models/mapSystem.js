...
export const MAP_THEMES = [
  {
    ...
    areas: [
      ...
      { id: "mountain-of-challenge", icon: "⛰️", name: "挑戦の山" },
      { id: "valley-of-passion", icon: "🔥", name: "情熱の谷" },
      { id: "career-city", icon: "🏙️", name: "キャリア都市" },
  ...
  },
  {
    ...
    areas: [
      ...
      { id: "gym-entrance", icon: "🏋️", name: "ジムの入口" },
      { id: "protein-spring", icon: "🍺", name: "プロテインの泉" },
      { id: "muscle-hill", icon: "🏋️", name: "筋肉の丘" },
      { id: "athlete-road", icon: "🎖️", name: "アスリート街道" },
      { id: "iron-bridge", icon: "⚡", name: "鉄人の橋" },
      { id: "unbreakable-range", icon: "⛰️", name: "不屈の山脈" },
      { id: "legendary-arena", icon: "🏟️", name: "伝説の闘技場" },
  ...
  },
  {
    ...
    areas: [
      ...
      { id: "savings-spring", icon: "🏛️", name: "貯金の泉" },
      { id: "investment-bridge", icon: "📈", name: "投資の橋" },
      { id: "asset-hill", icon: "💎", name: "資産の丘" },
      { id: "startup-road", icon: "🚀", name: "起業街道" },
      { id: "wealthy-district", icon: "🏙️", name: "富豪街" },
      { id: "freedom-gate", icon: "✈️", name: "経済的自由の門" },
  ...
  },
  {
    ...
    areas: [
      ...
      { id: "hill-of-works", icon: "🖼️", name: "作品の丘" },
  ...
  },
  {
    ...
    areas: [
      { id: "start", icon: "🌱", name: "スタート地点" },
      { id: "breathing-path", icon: "🌬️", name: "深呼吸の小道" },
      { id: "meditation-square", icon: "🧘", name: "瞑想の広場" },
      { id: "river-of-emotion", icon: "🌊", name: "感情の川" },
      { id: "resilience-bridge", icon: "🛡️", name: "ストレス耐性の橋" },
      { id: "calm-hill", icon: "🧘", name: "平常心の丘" },
      { id: "forest-of-introspection", icon: "👁️", name: "内省の森" },
      { id: "unshakable-range", icon: "⛰️", name: "不動の山脈" },
