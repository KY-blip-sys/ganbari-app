...
export const ACHIEVEMENT_LIST = [
  ...
  { id: "days-30", icon: "📅", name: "1ヶ月分の積み上げ", description: "記録した日数が合計30日", check: (ctx) => ctx.daysRecorded >= 30 },
  ...
  // ---------- ベストな一日 ----------
  { id: "best-day-100", icon: "⛅", name: "充実の一日", description: "1日の合計が100EXPを超える", check: (ctx) => ctx.bestDayExp >= 100 },
