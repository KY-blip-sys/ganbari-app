...
export const SKILL_TREES = {
  ...
  健康: [
    {
      ...
      nodes: [
        ...
        { id: "athlete", icon: "🎖️", name: "アスリート", requiredLevel: 8 },
    ...
    },
    {
      ...
      nodes: [
        ...
        { id: "ageless-body", icon: "🔄", name: "不老の身体", requiredLevel: 25 },
      ],
    },
  ],
  お金: [
  ...
  人間関係: [
    {
      ...
      nodes: [
        ...
        { id: "circle-of-trust", icon: "❤️", name: "信頼の輪", requiredLevel: 8 },
    ...
    },
    {
      ...
      nodes: [
        ...
        { id: "kindness-embodied", icon: "❤️", name: "思いやりの化身", requiredLevel: 16 },
        { id: "compassionate-one", icon: "😊", name: "慈愛の人", requiredLevel: 24 },
      ],
    },
    {
      id: "communication",
  ...
  趣味: [
    {
      ...
      nodes: [
        ...
        { id: "craftsman", icon: "🔨", name: "こだわり職人", requiredLevel: 8 },
  ...
  生活力: [
    ...
    },
    {
      ...
      label: "自炊",
      nodes: [
        { id: "home-cooking", icon: "🍽️", name: "自炊習慣", requiredLevel: 3 },
        { id: "thrifty-cook", icon: "🍽️", name: "節約自炊家", requiredLevel: 9 },
        { id: "nutrition-balancer", icon: "🥗", name: "栄養バランスの匠", requiredLevel: 16 },
        { id: "kitchen-meister", icon: "🍽️", name: "キッチンマイスター", requiredLevel: 24 },
      ],
    },
    {
      id: "organizing",
      label: "整理整頓・段取り",
      nodes: [
        { id: "planner", icon: "☑️", name: "段取り上手", requiredLevel: 4 },
        { id: "efficiency-master", icon: "⚙️", name: "効率化マスター", requiredLevel: 10 },
        { id: "scheduling-demon", icon: "📅", name: "スケジューリングの鬼", requiredLevel: 18 },
  ...
  メンタル: [
    {
      ...
      nodes: [
        ...
        { id: "unshakable-mind", icon: "⛰️", name: "不動心", requiredLevel: 22 },
      ],
    },
    {
      id: "mindfulness",
      ...
      nodes: [
        ...
        { id: "meditation-habit", icon: "🧖", name: "瞑想習慣", requiredLevel: 9 },
        { id: "calm-master", icon: "🧘", name: "平常心の達人", requiredLevel: 16 },
        { id: "enlightened", icon: "🧘", name: "悟りの境地", requiredLevel: 24 },
      ],
    },
    {
      ...
      nodes: [
        ...
        { id: "introspector", icon: "👁️", name: "内省の探求者", requiredLevel: 18 },
